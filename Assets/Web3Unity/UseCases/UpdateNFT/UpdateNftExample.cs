...
public class ItemInfo
{
	...
	[Parameter("uint256", "itemType", 2)]
	public BigInteger itemType { get; set; }
	
	[Parameter("uint256", "strength", 3)]
...
public class UpdateNftExample : MonoBehaviour
{
    [SerializeField]
	private Web3 web3;
	private string contractAddress="0x159D0A933137f3EC155f43834BDFCd534A8bfd61";
	...
	private void Start()
	{
		...
		web3.Initialize();
		contract = web3.GetContract(contractAddress, abi);
	}
