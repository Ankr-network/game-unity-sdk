...
public class ERC721Example : MonoBehaviour
{
	...
	private void Start()
	{
		...
		string contract_address = "0xE7ed0311067Ae31d2CD683fB6576aE0908E5BbC5";
		string provider_url = "https://rinkeby.infura.io/v3/c75f2ce78a4a4b64aa1e9c20316fda3e";
		
		Web3 web3 = new Web3(provider_url);
		web3.Initialize();
		ERC721 = web3.GetContract(contract_address, abi);
	}

	public async void CallMint()
	{
		string receipt = await ERC721.CallMethod("mint", new object[0]);
		Debug.Log($"Receipt: {receipt}");

		Transaction trx = await ERC721.GetTransactionInfo(receipt);
	...
	public async void GetBalance()
	{
		...
		BigInteger balance = await ERC721.GetData<BalanceOfMessage, BigInteger>(balanceOfMessage);
		Debug.Log($"Balance: {balance}");
	}
	
	public async void GetEvents()
	{
		var events = await ERC721.GetAllChanges<TransferEventDTO>();
