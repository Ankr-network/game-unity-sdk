...
namespace MirageSDKImporter.Data
{
	[CreateAssetMenu(fileName = "MirageSDKImporterSettings", menuName = "MirageSDK/ImporterSettings")]
	public class MirageSDKImporterSettings : ScriptableObject
	{
