...
namespace MirageSDK.Mobile
{
	public class EthHandler : IEthHandler
	{
			...
			string gasPrice = null, string nonce = null)
		{
			...
			var request = new MirageSDK.WalletConnectSharp.Core.Models.Ethereum.EthSendTransaction(transactionData);
			var response = await _walletConnect.Session
				.Send<MirageSDK.WalletConnectSharp.Core.Models.Ethereum.EthSendTransaction, EthResponse>(request);
