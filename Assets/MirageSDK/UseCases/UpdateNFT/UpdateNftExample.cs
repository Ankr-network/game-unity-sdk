...
namespace MirageSDK.UseCases.UpdateNFT
{
	public class UpdateNftExample : MonoBehaviour
	{
		...
		private IMirageContract _mirageContract;
		...
		private void Start()
		{
			...
			_mirageContract = _mirageSDKWrapper.GetContract(ContractAddress, ABI);
		}
		...
		public async void UpdateNFT()
		{
			...
			var receipt = await _mirageContract.CallMethod("updateTokenWithSignedMessage", new object[] { info });
