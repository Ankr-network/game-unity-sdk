...
namespace MirageSDK.WearableNFTExample
{
	public class WearableNFTExample : UseCase
	{
		...
		public override void ActivateUseCase()
		{
			...
			var MirageSDK = MirageSDKFactory.GetMirageSDKInstance(WearableNFTContractInformation.ProviderURL);
			_gameCharacterContract = MirageSDK.GetContract(
				WearableNFTContractInformation.GameCharacterContractAddress,
				WearableNFTContractInformation.GameCharacterABI);
			_gameItemContract = MirageSDK.GetContract(WearableNFTContractInformation.GameItemContractAddress,
				WearableNFTContractInformation.GameItemABI);
			_ethHandler = MirageSDK.Eth;
		}
